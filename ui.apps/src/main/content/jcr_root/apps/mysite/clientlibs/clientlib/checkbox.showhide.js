...
(function (document, $) {
    ...
    $(document).on("foundation-contentloaded", function (e) {
        ...
        checkboxShowHideHandler($(".cq-dialog-checkbox-showhide1", e.target));        
    });
     $(document).on("foundation-contentloaded", function (e) {
        // if there is already an inital value make sure the according target element becomes visible
        checkboxShowHideHandler($(".cq-dialog-checkbox-showhide2", e.target));        
    });
 
    $(document).on("change", ".cq-dialog-checkbox-showhide1", function (e) {
        checkboxShowHideHandler($(this));
    });
    $(document).on("change", ".cq-dialog-checkbox-showhide2", function (e) {
        checkboxShowHideHandler($(this));
    });
